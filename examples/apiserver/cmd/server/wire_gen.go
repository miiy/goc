...
func initApp(conf string) (*app.App, func(), error) {
	...
	zapLogger := providerZap(loggerLogger)
	...
	appApp := app.NewApp(configConfig, dbDB, universalClient, loggerLogger, jwtAuth, authServer)
	return appApp, func() {
	}, nil
}
...
func providerZap(logger2 logger.Logger) *zap.Logger {
